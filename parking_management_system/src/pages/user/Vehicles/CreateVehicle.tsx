...
export function CreateVehicle({ open, openChange }: { open: boolean, openChange: (open: boolean) => void }) {
  ...
  return (
    <div className='max-h-[500px] overflow-auto'>
      <PageHeader title="Add New Vehicle" description="Register a new vehicle in the system" />
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex gap-4 justify-end">
                ...
                <Button type="submit" disabled={createVehicleMutation.isPending}>
                  {createVehicleMutation.isPending ? 'Creating...' : 'Add Vehicle'}
                </Button>
              </div>
            </form>
          </Form>
