...
export function BookSlot({ open, openChange,selectedSlotId }: { open: boolean, openChange: (open: boolean) => void,selectedSlotId:string }) {
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent className="max-h-72">
                              ...
                              <SelectItem key={slotData?.data?.id} value={slotData?.data?.id}>
                        ...
                        <SelectContent className="max-h-72">
                          {vehiclesData && vehiclesData.data.length > 0 ? (
                            vehiclesData.data.map((vehicle) => (
                              <SelectItem key={vehicle.id} value={vehicle.vehiclePlateNumber}>
                                {vehicle.vehiclePlateNumber} - {vehicle.vehicleBrand} {vehicle.vehicleModel}
                              </SelectItem>
                            ))
                          ) : (
                ...
                <div className="flex gap-4 justify-end">
                  ...
                  <Button type="submit" disabled={isPending || !slotData?.data || !vehiclesData?.data.length}>
