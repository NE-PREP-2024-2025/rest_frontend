...
const bulkSlotFormSchema = z.object({
  numberOfSlots: z.string()
    ...
    .refine(value => Number(value) <= 100, { message: 'Cannot create more than 100 slots at once' }),
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex gap-4 justify-end">
                ...
                <Button type="submit" disabled={createManySlotssMutation.isPending}>
                  {createManySlotssMutation.isPending ? 'Creating...' : 'Create Slots'}
                </Button>
              </div>
            </form>
          </Form>
