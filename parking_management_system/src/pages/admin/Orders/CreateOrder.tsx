...
export function CreateOrder({ open, openChange }: { open: boolean, openChange: (open: boolean) => void }) {
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex gap-4 justify-end">
                  ...
                  <Button type="submit" disabled={isPending || !slotsData?.data?.length || !vehiclesData?.data?.length}>
